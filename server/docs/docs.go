...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/huasu.CarouselManage"
                        }
                    }
                ],
                "responses": {
        ...
        "/Carousel/deleteCarouselManageByIds": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/Carousel/getCarouselManageList": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/Carousel/getCarouselManagePublic": {
            "get": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/constructionManage/createConstructionManage": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/huasu.ConstructionManage"
                        }
                    }
                ],
                "responses": {
        ...
        "/constructionManage/deleteConstructionManage": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/constructionManage/deleteConstructionManageByIds": {
            "delete": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/constructionManage/findConstructionManage": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/constructionManage/getConstructionManageList": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/constructionManage/getConstructionManagePublic": {
            "get": {
                "consumes": [
                    "application/json"
                ],
        ...
        "/constructionManage/updateConstructionManage": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
    ...
    "definitions": {
        ...
        "config.Server": {
            ...
            "properties": {
                ...
                "email": {
                    "$ref": "#/definitions/github_com_kuihuar_huasu-admin_server_config.Email"
                },
                "excel": {
        ...
        "github_com_kuihuar_huasu-admin_server_config.Email": {
            "type": "object",
            "properties": {
                "from": {
        ...
        "huasu.CarouselManage": {
            ...
            "properties": {
                ...
                "description": {
                    "description": "轮播图描述（管理后台备注，如 “618 活动主视觉”）",
                    "type": "string"
                },
                "image": {
                    "description": "轮播图片的存储路径或 CDN 链接",
                    "type": "string"
                },
                "link": {
                    "description": "点击轮播图后的跳转链接",
                    "type": "string"
                },
                "sort": {
                    "description": "排序权重",
                ...
                "status": {
                    "description": "状态（如：1 - 启用、0 - 禁用、2 - 草稿，控制是否在前端显示）",
                    "type": "integer"
                },
                "target": {
                    "description": "链接打开方式",
        ...
        "huasu.Notice": {
            ...
            "properties": {
                ...
                "start_time": {
                    "description": "生效时间（可选，定时发布）",
                    "type": "string"
                },
                "status": {
                    "description": "发布状态（必填），控制公告是否对外展示，常见值： - 0：草稿（仅创建者可见，未提交审核） - 1：待审核（提交给管理员，未发布） - 2：已发布（全员 / 指定用户可见） - 3：已下架（历史公告，不再展示）",
                    "type": "integer"
                },
                "summary": {
                    "description": "公告摘要（可选）",
                ...
                "top": {
                    "description": "是否置顶（可选），1 = 置顶，0 = 不置顶，置顶公告在列表页优先排序（如紧急系统通知）。",
                    "type": "integer"
                },
                "type": {
                    "description": "公告类型（必填，用于分类筛选），如： - 按业务分：系统公告、活动公告、通知公告、预警公告 - 按部门分：全员公告、技术部公告、财务部公告",
                    "type": "integer"
                },
                "updatedAt": {
                    "description": "更新时间",
